...
namespace JG_GL
{
    public partial class GLScene : UserControl
    {
        ...
        public string VertexShader
        {
            ...
            set { my_VertexShader = value; }
        }

        public string FragmentShader
        {
            get { return my_FragmentShader; }
            set { my_FragmentShader = value; }
        }
        ...
        /// The default PerPixel Shaders are used if the Shader files can not be found.
        /// </summary>
        ...
        {
            if (!File.Exists(vertexShaderFile) || !File.Exists(fragmentShaderFile))
            {
                LoadDefaultShaders();
            }
            else
        ...
        /// <summary>
        /// Use the default PerPixel Shaders
        /// </summary>
